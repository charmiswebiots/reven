...
class CustomButton extends StatelessWidget {
  ...
  const CustomButton({Key? key, required this.title, this.padding = 15, this.radius = 10, this.onTap, this.style, this.color, this.icon, this.iconColor, this.iconSize = 25, this.width, this.border, this.height}) : super(key: key);
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            child: Container(
              ...
              height: height != null ? appScreenUtil.screenWidth(height!) : MediaQuery.of(context).size.height,
